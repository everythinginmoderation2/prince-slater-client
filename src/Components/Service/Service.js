...
function Service() {
    return (
        <div className="service">
                ...
                practice with me for as long as desired for the best results.</caption>
                ...
                you desire to play only your favorites or for fun, we will practice the specific songs.</caption>
            </div>
